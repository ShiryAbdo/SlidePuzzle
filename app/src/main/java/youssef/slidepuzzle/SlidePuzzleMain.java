...
import youssef.slidepuzzle.SlidePuzzleView.ShowNumbers;
...
public class SlidePuzzleMain extends Activity implements MediaPlayer.OnCompletionListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Uri path = Uri.parse("android.resource://youssef.slidepuzzle/" + R.drawable.dolby);
